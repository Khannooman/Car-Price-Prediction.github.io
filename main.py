...
def predict():
    if request.method == "POST":
        wheelbase = float(request.form["Wheel Base"])
        carlength  = float(request.form["Car lenght"])
        carwidth = float(request.form["Card Width"])
        curbweight = float(request.form["Curb wight"])
        cylindernumber = float(request.form["Cylinder Number"])
        enginesize = float(request.form["Engine Size"])
        boreratio = float(request.form["Bore ratio"])
        horsepower = float(request.form["Horse Power"])
        citympg = float(request.form["City Mpg"])
        highwaympg = float(request.form["HighWay Mpg"])
        ...
        enginetype = request.form["Engine type"]
        ...
        fuelsystem = request.form["Fuel System"]
        ...
        aspiration = request.form["Aspration"]
        ...
        cylindernumber = request.form["Cylinder Number"]
